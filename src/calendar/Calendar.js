...
export const Calendar = React.memo(
    React.forwardRef((props, ref) => {
            ...
            if (props.yearNavigator) {
                ...
                if (props.yearNavigatorTemplate) {
                    const options = displayedYearNames.map((name, i) => {
                        return { label: parseInt(name) + diffYear, value: name, index: i };
                    });
                    const defaultContentOptions = {
        ...
        const createTitleDecadeElement = () => {
            ...
            let diffYear = props.locale === 'th' ? 543 : 0;
            if (currentView === 'year') {
                return <span className="p-datepicker-decade">{props.decadeTemplate ? props.decadeTemplate(years) : <span>{`${yearPickerValues()[0]+diffYear} - ${yearPickerValues()[yearPickerValues().length - 1]+diffYear}`}</span>}</span>;
            }
        ...
        const createHourPicker = () => {
            ...
            return (
                <div className="p-hour-picker">
                    {
                        props.showHeaderTime && <span className='text-base'>{headerHour}</span>
                    }
                    <button
                        type="button"
                        className="p-link"
        ...
        const createMinutePicker = () => {
            ...
            return (
                <div className="p-minute-picker">
                    {
                        props.showHeaderTime && <span className='text-base'>{headerMinute}</span>
                    }
                    <button
                        type="button"
                        className="p-link"
            ...
            if (props.showSeconds) {
                ...
                return (
                    <div className="p-second-picker">
                        {
                            props.showHeaderTime && <span className='text-base'>{headerSecond}</span>
                        }
                        <button
                            type="button"
                            className="p-link"
